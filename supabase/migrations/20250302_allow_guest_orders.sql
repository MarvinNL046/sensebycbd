...
-- Add a policy to allow guests to view their own orders (using a session cookie or similar)
-- This would typically be implemented in the application code, but we'll add a placeholder policy
