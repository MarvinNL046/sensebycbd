...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    title: 'CBD Blog | SenseBy CBD',
    description: 'Read the latest articles about CBD benefits, research, and product guides. Stay informed with SenseBy CBD\'s educational blog.',
  };
}
